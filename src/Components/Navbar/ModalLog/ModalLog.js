...
import stylesFor from './ModalLog.module.css';
    ...
    <div className="modal-dialog">
      <div className="modal-content align-items-center justify-content-center">
       <div className={`${stylesFor.loginContainer} d-flex  align-items-center justify-content-center`}>
         <form action="" className={`${stylesFor.loginForm} text-center`}>
           <h1 className="mb-5 font-weight-light text-uppercase">Login</h1>
           <div className="form-group">
             <input type="text" class={`form-control rounded-pill form-control-lg ${stylesFor.control}`} placeholder="Username" />
           </div>
           <div className="form-group">
          ...
          <div className={`${stylesFor.emergency} d-flex align-items-center justify-content-between`}>
            ...
            <a className={stylesFor.loginFormForA} href="#">Forgot Password</a>
          </div>
